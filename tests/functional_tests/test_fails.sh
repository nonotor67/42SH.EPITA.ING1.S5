...
test_functional "Bad for loop" 'for i in 1 2 3; do echo $i; done; done'
test_functional "Bad while loop" 'while false; do echo "toto"; done; done'
test_functional "Bad if condition" 'if true; then echo "toto"; fi; fi'
test_functional "Bad if condition (no then)" 'if true; fi'
test_functional "Bad for loop (no do)" 'for i in 1 2 3; echo $i; done'
